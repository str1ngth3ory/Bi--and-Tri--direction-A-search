...
* **Do not** use graph.explored_nodes for anything in regard to what you want Bonnie to grade. This can be used for debugging, but you should not be calling this in your code. **In addition to this, there is a very important note about the code you should write in the "Notes" section. Please read this carefully.**
